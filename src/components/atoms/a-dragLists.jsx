...
class ADragLists extends Component {
  ...
  arrayMove = (arr, old_index, new_index) => {
    const {onChangeOld, onChangeNew, data} = this.props;
    onChangeOld(Object.assign({}, ...data.filter((x, i) => i == old_index)));
    onChangeNew(Object.assign({}, ...data.filter((x, i) => i == new_index)));
...
export default ADragLists;

ADragLists.defaultProps = {
  scrollPercent: 5,
  scrollSpeed: 10,
